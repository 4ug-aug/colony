  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background shadow-lg transition-[transform,opacity] ease-in-out data-ending-style:duration-300 data-starting-style:duration-500",
          side === "right" &&
