...
import { getBrailleCharacters } from '#/lib/text-to-braille.ts'
...
export function BrailleLoader({
  ...
  return (
    <span className={cn('inline-flex', className)}>
      ...
      <span aria-hidden="true" className="braille-loader-glyphs font-mono">
        <style>{`${variantStyles[variant]} @media (prefers-reduced-motion: reduce) { .braille-loader-glyphs > span { animation: none !important; } }`}</style>
